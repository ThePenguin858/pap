...
from xquant.refactor.model.AutoEncoder import autoEncoder_train
...
#(6)搭建模型
ae_model, encoder_model = autoEncoder_train(X_train, X_vali,[16,4], [16], epoches = 2000)

#(7)测试模型     
X_predict = ae_model.predict(X_test)
